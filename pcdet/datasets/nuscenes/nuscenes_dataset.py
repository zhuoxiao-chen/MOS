...
if cfg.get("TTA", None) and cfg.TTA.get("CORRUPTION", None):
    from ..corruption_tool import LiDAR_corruptions
...
class NuScenesDataset(DatasetTemplate):
    ...
    def get_lidar_with_sweeps(self, index, max_sweeps=1):
        ...
        if cfg.get("TTA", None) and cfg.TTA.get("CORRUPTION", None):
            lidar_path = Path(cfg.TTA.CORRUPTION_PATH) / cfg.TTA.CORRUPTION / cfg.TTA.CORRUPTION_SEVERITY / info['lidar_path']
            # print(lidar_path)
